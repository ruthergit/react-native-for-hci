...
const ExerciseStartMobility = () => {
  ...
  const exercises = [
    {
      label: 'Calf Raises',
      video: require('../../assets/images/SeatedLower/CalfRaises.mp4'),
    },
    {
      label: 'Seated Hamstring Stretch',
      video: require('../../assets/images/SeatedLower/KneeExtensions.mp4'),
    },
    {
      label: 'Seated Piriform Stretch',
      video: require('../../assets/images/SeatedLower/LegRaises.mp4'),
    },
  ];
