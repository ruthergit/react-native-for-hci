...
const ExerciseStartMobility = () => {
  ...
  const exercises = [
    {
      label: 'Goal Post Stretching',
      video: require('../../assets/images/SeatedMobility/GoalPostStretching.mp4'),
    },
    {
      label: 'Seated Hamstring Stretch',
      video: require('../../assets/images/SeatedMobility/SeatedHamstringStretch.mp4'),
    },
    {
      label: 'Seated Piriform Stretch',
      video: require('../../assets/images/SeatedMobility/SeatedPiriformStretch.mp4'),
    },
  ];
