    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/SeatedUpper/BenchPressThumbnail.png')}
        ...
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/SeatedUpper/ShoulderPressThumbnail.png')}
                style={styles.thumbnailImg}
              />
              <View style={styles.exerciseTextContainer}>
        ...
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/SeatedUpper/UpperChestPressThumbnail.png')}
                style={styles.thumbnailImg}
              />
              <View style={styles.exerciseTextContainer}>
                <Text style={styles.exerciseText}>Upper Chest Press</Text>
                <Text style={styles.exerciseText}>3 x 25 seconds</Text>
              </View>
        </View>
            <View>
