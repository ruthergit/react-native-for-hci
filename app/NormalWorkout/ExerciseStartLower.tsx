  ...
  const exercises = [
    {
      ...
      video: require('../../assets/images/Lower/AssistedSquats.mp4'),
    },
    {
      label: 'Goodmornings',
      video: require('../../assets/images/Lower/Goodmornings.mp4'),
    },
    {
      label: 'Hip Extentions',
      video: require('../../assets/images/Lower/HipExtention.mp4'),
    },
  ];
