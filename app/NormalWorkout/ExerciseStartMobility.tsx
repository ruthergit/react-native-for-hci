...
const ExerciseStartMobility = () => {
  ...
  const exercises = [
    {
      label: 'Ball Circles',
      video: require('../../assets/images/Mobility/BallCircles.mp4'),
    },
    {
      label: 'Knee Taps',
      video: require('../../assets/images/Mobility/KneeTaps.mp4'),
    },
    {
      label: 'Wall Angles',
      video: require('../../assets/images/Mobility/WallAngles.mp4'),
    },
  ];
