...
const ExerciseStartMobility = () => {
  ...
  const exercises = [
    {
      label: 'Bicep Curls',
      video: require('../../assets/images/Upper/BicepCurls.mp4'),
    },
    {
      label: 'Shoulder Press',
      video: require('../../assets/images/Upper/LateralRaises.mp4'),
    },
    {
      label: 'Upper Chest Press',
      video: require('../../assets/images/Upper/OverheadPress.mp4'),
    },
  ];
