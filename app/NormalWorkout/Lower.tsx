    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/Lower/AssistedSquatsThumbnail.png')}
                style={styles.thumbnailImg}
              />
              <View style={styles.exerciseTextContainer}>
                <Text style={styles.exerciseText}>Assisted Squats</Text>
                <Text style={styles.exerciseText}>3 x 25 seconds</Text>
              </View>
        </View>
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/Lower/GoodmorningsThumbnail.png')}
                style={styles.thumbnailImg}
              />
              <View style={styles.exerciseTextContainer}>
                <Text style={styles.exerciseText}>Goodmornings</Text>
                <Text style={styles.exerciseText}>3 x 25 seconds</Text>
              </View>
        </View>
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/Lower/HipExtentionThumbnail.png')}
                style={styles.thumbnailImg}
              />
              <View style={styles.exerciseTextContainer}>
                <Text style={styles.exerciseText}>Hip Extentions</Text>
                <Text style={styles.exerciseText}>3 x 25 seconds</Text>
              </View>
        </View>
            <View>
