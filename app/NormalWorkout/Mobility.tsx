    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/Mobility/BallCirclesThumbnail.png')}
                style={styles.thumbnailImg}
              />
              <View style={styles.exerciseTextContainer}>
                <Text style={styles.exerciseText}>Ball Circles</Text>
                <Text style={styles.exerciseText}>3 x 25 seconds</Text>
              </View>
        </View>
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/Mobility/KneeTapsThumbnail.png')}
                style={styles.thumbnailImg}
              />
              <View style={styles.exerciseTextContainer}>
                <Text style={styles.exerciseText}>Knee Taps</Text>
                <Text style={styles.exerciseText}>3 x 25 seconds</Text>
              </View>
        </View>
        <View style={styles.exerciseContainer}>
              <Image
                source={require('../../assets/images/Mobility/WallAnglesThumbnail.png')}
                style={styles.thumbnailImg}
              />
              <View style={styles.exerciseTextContainer}>
                <Text style={styles.exerciseText}>Wall Angles</Text>
                <Text style={styles.exerciseText}>3 x 25 seconds</Text>
              </View>
        </View>
            <View>
